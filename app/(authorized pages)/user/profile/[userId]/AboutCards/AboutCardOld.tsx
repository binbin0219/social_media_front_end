...
const AboutCardOld = ({profileUser}: Props) => {
    return (
        <div className="w-full bg-bgSecondary rounded-xl border border-borderPrimary shadow-md p-6 sm:p-8 text-textPrimary">
            <h1 className="text-2xl font-bold text-textPrimary pb-4 mb-6 border-b border-borderPrimary">About</h1>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-y-6 gap-x-8">

                {/* Name */}
                <div className="flex items-start gap-4">
                    <div className="flex-shrink-0 text-textPrimary/60">
                    ...
                    <div>
                        ...
                        {!profileUser?.firstName && !profileUser?.lastName ? (
                            <p className="text-textPrimary/60 italic">Unknown</p>
                        ) : (
                            <p className="text-textPrimary">{profileUser?.firstName} {profileUser?.lastName}</p>
                        )}
                    </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                    ...
                    <div>
                        <h4 className="font-semibold text-textPrimary">Gender</h4>
                        <p className="text-textPrimary">{profileUser?.gender || "Unknown"}</p>
                    </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                    ...
                    <div>
                        <h4 className="font-semibold text-textPrimary">Location</h4>
                        {profileUser?.country ?
                            <p className="text-textPrimary">From {profileUser.country}{profileUser.region ? `, ${profileUser.region}` : ""}</p>
                        :
                            <p className="text-textPrimary/60 italic">Unknown</p>
                        }
                    </div>
                ...
                <div className="flex items-start gap-4">
                    ...
                    <div>
                        <h4 className="font-semibold text-textPrimary">Relationship</h4>
                        <p className="text-textPrimary">{profileUser?.relationshipStatus || "Unknown"}</p>
                    </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                    ...
                    <div>
                        <h4 className="font-semibold text-textPrimary">Occupation</h4>
                        <p className="text-textPrimary">{profileUser?.occupation || "Unknown"}</p>
                    </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                    ...
                    <div>
                        <h4 className="font-semibold text-textPrimary">Phone Number</h4>
                        {profileUser?.phoneNumber?.dialCode && profileUser?.phoneNumber?.phoneNumberBody ?
                            <p className="text-textPrimary">+{profileUser.phoneNumber.dialCode} {profileUser.phoneNumber.phoneNumberBody}</p>
                        :
                            <p className="text-textPrimary/60 italic">Unknown</p>
                        }
                    </div>
