...
const NotificationCounter = () => {
    ...
    return (
        <div id="notification_count" className={`${newNotificationCount === 0 && 'hidden'} absolute pointer-events-none top-[-3px] right-[-3px] w-[19px] h-[19px] flex items-center justify-center bg-white rounded-full`}>
