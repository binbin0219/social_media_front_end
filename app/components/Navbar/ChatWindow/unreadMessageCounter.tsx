...
const UnreadMessageCounter = () => {
    ...
    return (
        <div className={`${unreadChatMessageCount === 0 && 'hidden'} absolute pointer-events-none top-[-4px] right-[-6px] w-[19px] h-[19px] flex items-center justify-center bg-white rounded-full`}>
